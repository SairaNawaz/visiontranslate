        ...
        for (int i = 0; i < items.size(); ++i) {
            ...
            for (final Text currentText : textComponents) {
                final Translation translation =
                        MainActivity.google_translate.translate(currentText.getValue(),
                                Translate.TranslateOption.targetLanguage(MainActivity.target_language));

                OcrGraphic graphic = new OcrGraphic(mGraphicOverlay, currentText,translation.getTranslatedText());
